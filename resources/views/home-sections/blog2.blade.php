        ...
        <div class="row">
            ...
            <div class="col-right col-sm-9 no-padding">
                ...
                * Available carousel data attributes:
                ...
                -->
                <div class="col-inner owl-carousel article-carousel" data-items="4" data-items-tablet="3" data-items-mobile-landscape="2" data-items-mobile-portrait="1" data-loop="true" data-autoplay="true" data-autoplay-timeout="8000" data-autoplay-hover-pause="true" data-autoplay-speed="600" data-dots="false" data-nav="true" data-nav-speed="600">
                    ...
                    <article class="article article-1 bg-image" style="background-image: url(img/article/article-1.jpg);">
                        ...
                        <div class="caption">
                            ...
                            <div class="entry-meta">
                                ...
                                <span class="posted-by">- Di <a href="#" title="Tutti i post di Admin">Admin</a></span>
                                <span class="posted-in">- in <a href="#" title="View all posts in Sezione">Sezione</a></span>
                            </div>
                        </div>
                    </article>
                    ...
                    <article class="article article-2 bg-image" style="background-image: url(img/article/article-2.jpg);">
                        ...
                        <div class="caption">
                            ...
                            <div class="entry-meta">
                                <span class="published">1 giorni fa</span>
                                <span class="posted-by">- Di <a href="#" title="Tutti i post di Admin">Admin</a></span>
                                <span class="posted-in">- in <a href="#" title="View all posts in Sezione">Sezione</a></span>
                            </div>
                        </div>
                    ...
                    <article class="article article-3 bg-image" style="background-image: url(img/article/article-3.jpg);">
                        ...
                        <div class="caption">
                            ...
                            <div class="entry-meta">
                                <span class="published">3 giorni fa</span>
                                <span class="posted-by">- Di <a href="#" title="Tutti i post di Admin">Admin</a></span>
                                <span class="posted-in">- in <a href="#" title="View all posts in Sezione">Sezione</a></span>
                            </div>
                        </div>
            ...
            <div class="col-right col-sm-3 no-padding">
                <div class="col-inner blog-heading2">
                    <a href="/" target="_blank" class="article-link"></a>
                    <!-- Begin Heading -->
                    <div class="heading heading-md align-center">
                        <h1>Articoli</h1>
                        <p>Leggi tutti gli articoli <i class="fa fa-arrow-left"></i></p>
                    </div>
                    <!-- End Heading -->
                </div> <!-- /.col-inner -->
            </div> <!-- /.col -->
